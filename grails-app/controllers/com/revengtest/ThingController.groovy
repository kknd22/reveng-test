...
class ThingController {
    ...
    def save(Thing thingInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'thingInstance.label', default: 'Thing'), thingInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'thingInstance.label', default: 'Thing'), params.id])
                redirect action: "index", method: "GET"
            }
