...
class AuthorController {
    ...
    def save(Author authorInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'authorInstance.label', default: 'Author'), authorInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'authorInstance.label', default: 'Author'), params.id])
                redirect action: "index", method: "GET"
            }
