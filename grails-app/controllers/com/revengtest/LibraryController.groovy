...
class LibraryController {
    ...
    def save(Library libraryInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'libraryInstance.label', default: 'Library'), libraryInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'libraryInstance.label', default: 'Library'), params.id])
                redirect action: "index", method: "GET"
            }
