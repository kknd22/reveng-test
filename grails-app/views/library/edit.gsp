...
<html>
	...
	<body>
		<a href="#edit-library" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-library" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:libraryInstance, action:'update']" method="PUT" >
